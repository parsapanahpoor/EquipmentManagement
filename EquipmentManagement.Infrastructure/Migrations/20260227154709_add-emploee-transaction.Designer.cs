...
namespace EquipmentManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260227154709_add-emploee-transaction")]
    partial class addemploeetransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.Employee.EmployeeReceiveFoodDeliveryReceiptLog", b =>
                {
                    ...
                    b.Property<decimal?>("MealPricingId")
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.Employee.EmployeeTransaction", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.OrganizationRequest.AbolitionRequest.AbolitionRequest", b =>
                {
                    ...
                    b.Property<int>("ExpertVisitorAbolitionRequestState")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.OrganizationRequest.AbolitionRequest.DecisionAbolitionRequestRespons", b =>
                {
                    ...
                    b.Property<decimal>("AbolitionRequestId")
                        .HasColumnType("decimal(20,0)");
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.OrganizationRequest.OrganizationRequestDocumentEntity", b =>
                {
                    ...
                    b.Property<int>("OrganizationRequestType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.Product.Product", b =>
                {
                    ...
                    b.Property<string>("InvoiceUniqueNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsAbolition")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.Account.UserRole", b =>
                {
                    b.HasOne("EquipmentManagement.Domain.Entities.Account.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EquipmentManagement.Domain.Entities.Users.User", null)
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.Employee.EmployeeReceiveFoodDeliveryReceiptLog", b =>
                {
                    ...
                    b.HasOne("EquipmentManagement.Domain.Entities.MealPricing.MealPricing", "MealPricing")
                        .WithMany("EmployeeReceiveFoodDeliveryReceiptLog")
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.OrganizationRequest.OrganizationRequestDocumentEntity", b =>
                {
                    b.HasOne("EquipmentManagement.Domain.Entities.Users.User", "User")
                        .WithMany("OrganizationRequestDocumentEntities")
                        .HasForeignKey("EmployeeUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.MealPricing.MealPricing", b =>
                {
                    b.Navigation("EmployeeReceiveFoodDeliveryReceiptLog");
                });
            ...
            modelBuilder.Entity("EquipmentManagement.Domain.Entities.Users.User", b =>
                {
                    b.Navigation("OrganizationRequestDocumentEntities");
